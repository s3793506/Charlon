					...
					<section id="sidebar">
						...
						<!-- About -->
							<section class="blurb">
								...
								<p class="ieMR"> Children's Health Queensland Hospital and Health Service. (2019) <i>ieMR Advanced FAQs</i>. Available at: https://www.childrens.health.qld.gov.au/iemr-advanced-faq/ (Accessed:17 March 2019)</a>.
								<ul class="actions">
								</ul>
							</section>
						<!-- Footer -->
